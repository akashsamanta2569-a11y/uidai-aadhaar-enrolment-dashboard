...
# --- 1. Custom AI Function (Replaces sklearn) ---
# This function calculates the "Line of Best Fit" using pure math (Least Squares Method)
...
@app.route("/")
def home():
    # --- PART 1: HARDCODED DATA FOR CHARTS ---
    # Since pandas might also give errors on 3.13, we hardcode the top 10 states here.
    # This is safer for your demo.
    states = ["Uttar Pradesh", "Bihar", "Maharashtra", "West Bengal", "Madhya Pradesh", 
              "Rajasthan", "Tamil Nadu", "Gujarat", "Karnataka", "Andhra Pradesh"]
    
    # Approx numbers matching your previous CSV
    ...
    # --- PART 2: FUTURE PREDICTION (Pure Python AI) ---
    ...
    # Connect the line: Start prediction from the last known year (2025)
